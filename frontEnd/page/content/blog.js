            ...
            <div class="card-overlay-content mt-3">
                <div class="d-flex">
                    ...
                    <div class="justify-content-end ms-auto">
                        <p class="small mb-0 badge-category">${item.date}</p>
                    </div>
                </div>
...
content.innerHTML = `
    <div class="container-sm blog-header-container">
        <div class="changeTheme btn-changeTheme container-sm d-flex justify-content-center animate__animated animate__jackInTheBox"></div>
